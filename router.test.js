...
describe('OpenAPIRouter', function () {
    ...
    describe('.matchOperation with apiRoot = /api', function () {
        var api = new router_1.OpenAPIRouter({ definition: definition, apiRoot: '/api' });
        test('matches GET /api as apiRoot', function () { return __awaiter(_this, void 0, void 0, function () {
            var operationId;
            return __generator(this, function (_a) {
                operationId = api.matchOperation({ path: '/api', method: 'get', headers: headers }).operationId;
                expect(operationId).toEqual('apiRoot');
                return [2 /*return*/];
            });
        }); });
        test('matches GET /api/pets as getPets', function () { return __awaiter(_this, void 0, void 0, function () {
            var operationId;
            return __generator(this, function (_a) {
                operationId = api.matchOperation({ path: '/api/pets', method: 'get', headers: headers }).operationId;
                expect(operationId).toEqual('getPets');
                return [2 /*return*/];
            });
        }); });
...
describe('OpenAPIBackend', function () {
    ...
    describe('.handleRequest postResponseHandler', function () { return __awaiter(_this, void 0, void 0, function () {
        var dummyHandlers, dummyHandler, api;
        var _this = this;
        return __generator(this, function (_a) {
            dummyHandlers = {};
            ...
            beforeAll(function () { return api.init(); });
            test('handles GET / and passes response to postResponseHandler', function () { return __awaiter(_this, void 0, void 0, function () {
                var postResponseHandler, res, contextArg;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            postResponseHandler = jest.fn(function (c) { return c.response; });
                            return [4 /*yield*/, api.register({ postResponseHandler: postResponseHandler })];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, api.handleRequest({ method: 'GET', path: '/', headers: headers })];
                        case 2:
                            res = _a.sent();
                            expect(dummyHandlers['apiRoot']).toBeCalled();
                            expect(postResponseHandler).toBeCalled();
                            expect(res).toEqual({ operationId: 'apiRoot' });
                            contextArg = postResponseHandler.mock.calls.slice(-1)[0][0];
            ...
            test('handles GET /pets and passes response to postResponseHandler', function () { return __awaiter(_this, void 0, void 0, function () {
                var postResponseHandler, res, contextArg;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, api.handleRequest({ method: 'GET', path: '/pets', headers: headers })];
                        case 2:
                            res = _a.sent();
                            expect(dummyHandlers['getPets']).toBeCalled();
                            expect(postResponseHandler).toBeCalled();
            ...
            test('handles GET /pets and allows postResponseHandler to intercept response', function () { return __awaiter(_this, void 0, void 0, function () {
                var postResponseHandler, res, contextArg;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            postResponseHandler = jest.fn(function () { return ({ you: 'have been intercepted' }); });
                            return [4 /*yield*/, api.register({ postResponseHandler: postResponseHandler })];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, api.handleRequest({ method: 'GET', path: '/pets', headers: headers })];
