...
var OpenAPIBackend = /** @class */ (function () {
    ...
    function OpenAPIBackend(opts) {
        ...
        var optsWithDefaults = __assign({ apiRoot: '/', withContext: true, validate: true, strict: false, ajvOpts: {}, handlers: {} }, opts);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        this.validator = new validation_1.OpenAPIValidator({ definition: this.definition, ajvOpts: this.ajvOpts, router: this.router });
                        // we are initalized
    ...
    OpenAPIBackend.prototype.handleRequest = function (req) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var context, response, postResponseHandler;
            var _this = this;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (function () { return __awaiter(_this, void 0, void 0, function () {
                                var notFoundHandler, _a, path, operationId, validate, validationFailHandler, routeHandler, notImplementedHandler;
                                return __generator(this, function (_b) {
                                    ...
                                    validate = typeof this.validate === 'function' ? this.validate.apply(this, [context].concat(handlerArgs)) : Boolean(this.validate);
                                    ...
                                    if (!routeHandler) {
                                        ...
                                        return [2 /*return*/, this.withContext
                                                ? notImplementedHandler.apply(void 0, [context].concat(handlerArgs)) : notImplementedHandler.apply(void 0, handlerArgs)];
                                    }
                                    // handle route
                    ...
                    case 3:
                        response = _a.sent();
                        postResponseHandler = this.handlers['postResponseHandler'];
                        if (postResponseHandler) {
                            // pass response to postResponseHandler
                            context.response = response;
                            return [2 /*return*/, this.withContext ? postResponseHandler.apply(void 0, [context].concat(handlerArgs)) : postResponseHandler.apply(void 0, handlerArgs)];
                        }
                        // return response
    ...
    OpenAPIBackend.prototype.mockResponseForOperation = function (operationId, opts) {
        ...
        if (!response) {
            var res = utils_1.default.findDefaultStatusCodeMatch(responses);
            status = res.status;
            response = res.res;
        }
     ...
     * @memberof OpenAPIBackend
     */
    OpenAPIBackend.prototype.validateRequest = function (req, operation) {
     ...
     * @memberof OpenAPIBackend
     */
    OpenAPIBackend.prototype.validateResponse = function (res, operation) {
     ...
     * @memberof OpenAPIBackend
     */
    OpenAPIBackend.prototype.validateResponseHeaders = function (headers, operation, opts) {
